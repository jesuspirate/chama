...
export function VerticalIcon({
  ...
  if (vertical === "chama") {
    // Inlined (Jet, 2026-09-17): this mark used to be a per-theme <img>
    ...
    // Filled radius matches the outlined seats: 17 + half of the 9px stroke.
