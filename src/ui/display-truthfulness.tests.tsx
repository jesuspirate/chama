...
assert.equal(readKind0Toggle(other),true,'Names default on for a new identity');
writeKind0Toggle(other,false);assert.equal(readKind0Toggle(other),false,'An explicit opt-out persists');
assert.equal(readKind0Toggle(me),true,'An opt-out does not leak between identities');
