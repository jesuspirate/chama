...
export const app: Record<string, string> = {
  ...
  "app.fastSetupBusy": "Setting you up…",
  "app.fastSetupDesc": "Zero questions — start now, change home anytime from Me.",
  "app.openingInvite": "Opening your invite…",
  "app.openingInviteSub": "You're joining a friend — everything it needs comes with the link.",
  ...
  "app.reabsorbConsumedUncredited":
    "Your Chama has already accepted these notes — they can't be imported again, so they've stopped being offered. We can't confirm the sats reached this wallet, so it's kept as evidence — recovery may be possible in a later update.",
  "app.reabsorbDead":
  ...
  "app.listingExpired": "That listing expired before anyone locked — nothing was ever funded.",
