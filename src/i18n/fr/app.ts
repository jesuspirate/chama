...
export const app: Record<string, string> = {
  ...
  "app.fastSetupBusy": "Mise en place…",
  "app.fastSetupDesc": "Zéro question — commencez maintenant, changez de communauté quand vous voulez depuis Moi.",
  "app.openingInvite": "Ouverture de votre invitation…",
  "app.openingInviteSub": "Vous rejoignez un ami — tout le nécessaire arrive avec le lien.",
  ...
  "app.listingExpired": "Cette annonce a expiré avant tout verrouillage — rien n'a jamais été financé.",
